...
<div class="opening-container">
    ...
    <p>
      For clarifications, please contact the Asian College <br>
...
<div class="social-links">
  <a href="https://www.instagram.com/asiancollegedgte/" target="_blank" rel="noopener" aria-label="Instagram">
    <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#E4405F" width="32px" height="32px">
  ...
  <a href="https://www.facebook.com/AsianCollegeDumaguete" target="_blank" rel="noopener" aria-label="Facebook">
    <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" fill="#1877F2" viewBox="0 0 24 24" width="32px" height="32px">
   ...
   <a href="https://asiancollege.edu.ph" target="_blank" title="Website" aria-label="Website" style="display:inline-block; width:24px; height:24px;">
    <img src="assets/cropped-favicon-512-192x192.png" alt="Website" style="width:24px; height:24px; object-fit: contain;">
  </a>
</div>
