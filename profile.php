  ...
  <nav class="top-nav">
    ...
    <div class="menu">
      ...
      <ul id="menuItems" class="menuItems">
        ...
        <li><a href="employee.php" class="<?= $current_page === 'employee.php' ? 'active' : '' ?>">👨‍💼 Employee</a></li>
        <li><a href="addemployee.php" class="<?= $current_page === 'addemployee.php' ? 'active' : '' ?>">➕ Add New Employee</a></li>
